          ...
          >
            ...
            >
              <div className="flex flex-col space-y-6">
                ...
                <Link
                  href="/"
                  className="text-xl font-light tracking-tight text-zinc-900 dark:text-zinc-50"
                  onClick={() => setMobileNavOpen(false)}
                >
                  Books
                </Link>
                ...
                <div className="grid grid-cols-3 gap-2 pt-1">
                  <Link
                    href="/cart"
                    className="flex flex-col items-center justify-center p-3 border border-zinc-200 dark:border-zinc-800 text-zinc-900 dark:text-zinc-50 gap-1.5"
                    onClick={() => setMobileNavOpen(false)}
                  >
                    <svg
                      className="w-4 h-4"
      ...
      <nav className="w-full">
        <div className="mx-auto max-w-6xl px-4 h-16 flex items-center justify-between relative z-[110] bg-transparent md:grid md:grid-cols-[1fr_auto_1fr]">
          ...
          <div className="hidden md:flex items-center justify-self-center gap-6">
            <Link
              href="/"
              className="text-[10px] font-mono uppercase tracking-wider text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors"
            >
              Books
            </Link>
            <Link
          ...
          <div className="hidden md:flex items-center justify-self-end gap-5">
            <Link
              href="/wishlist"
              className="text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors relative p-1"
              title="Wishlist"
            >
              <svg
                className="w-4 h-4"
            ...
            <Link
              href="/cart"
              className="text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-100 transition-colors relative p-1 flex items-center gap-1"
              title="Cart"
            >
              <svg
                className="w-4 h-4"
              ...
              <span className="text-[9px] font-mono font-bold px-1 bg-zinc-900 text-white dark:bg-zinc-100 dark:text-zinc-900 scale-90">
                0
              </span>
            </Link>
            ...
            <Link
              href="/auth/signup"
              className="text-[10px] font-mono uppercase tracking-wider border border-zinc-200 bg-white px-2.5 py-1 text-zinc-900 hover:border-zinc-900 transition-colors dark:border-zinc-800 dark:bg-zinc-900 dark:text-zinc-100 dark:hover:border-zinc-50"
            >
              Sign Up
            </Link>
          </div>
          ...
          >
            <span
              className={`w-full h-[1px] bg-zinc-900 dark:bg-zinc-50 transition-transform duration-300 origin-top-left ${mobileNavOpen ? "rotate-45 translate-x-[2px]" : ""}`}
            />
            <span
              className={`w-full h-[1px] bg-zinc-900 dark:bg-zinc-50 transition-opacity duration-200 ${mobileNavOpen ? "opacity-0" : "opacity-100"}`}
            />
            <span
              className={`w-full h-[1px] bg-zinc-900 dark:bg-zinc-50 transition-transform duration-300 origin-bottom-left ${mobileNavOpen ? "-rotate-45 translate-x-[2px] -translate-y-[1px]" : ""}`}
            />
          </button>
        </div>
        {mobileMenu}
